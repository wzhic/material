...
export const configureCodexResourcesForTarget = async (
  ...
  forgeConfig.packagerConfig.extraResource = codexExtraResources(platform, arch);
};

const config: ForgeConfig = {
  packagerConfig: {
    asar: true,
    // Only the locked App Server binary and its Apache-2.0 license are shipped.
    // Shell helpers (rg/code-mode-host) are intentionally excluded.
