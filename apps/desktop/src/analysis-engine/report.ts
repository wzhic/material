...
export const fuseAnalysisReport = (
  ...
  return {
    ...
    model: {
      ...
      providerReasoningEffort: input.audit.providerReasoningEffort,
      providerRequestedModelId: input.audit.providerRequestedModelId,
      providerReturnedModelId: input.audit.providerReturnedModelId,
